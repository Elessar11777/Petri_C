...
button_widgets = [
    ...
    (ButtonActions.EXPOSURE_BOTTOM.value, 0.025, 0.9, "disabled"),
    (ButtonActions.MODES_BUTTON.value, 0.265, 0.9, "normal"),
    (ButtonActions.POSTPROCESSING_BUTTON.value, 0.5, 0.9, "normal"),
    (ButtonActions.CALIBRATION_BUTTON_B.value, 0.65, 0.37, "normal"),
    (ButtonActions.CALIBRATION_BUTTON_P.value, 0.65, 0.77, "normal"),
]
...
entry_widgets = [
    (CodeValues.ParameterNames.EXPOSURE_BOTTOM_MIN.value, 0.4, 0.13),
    (CodeValues.ParameterNames.EXPOSURE_BOTTOM_MAX.value, 0.4, 0.21),
    (CodeValues.ParameterNames.EXPOSURE_BOTTOM_NUM.value, 0.4, 0.29),
    (CodeValues.ParameterNames.EXPOSURE_BOTTOM_NUM_CALIBRATION.value, 0.4, 0.37),
    (CodeValues.ParameterNames.EXPOSURE_PERIF_MIN.value, 0.4, 0.53),
    (CodeValues.ParameterNames.EXPOSURE_PERIF_MAX.value, 0.4, 0.61),
    (CodeValues.ParameterNames.EXPOSURE_PERIF_NUM.value, 0.4, 0.69),
    (CodeValues.ParameterNames.EXPOSURE_PERIF_NUM_CALIBRATION.value, 0.4, 0.77),
]