...
def contour_cutter_circ(BP_images_dict, thrs=15, rplv=255):
    ...
    for _, image in BP_images_dict["B"].items():
        ...
        try:
            ...
            aeya_logger.debug(f"Roundness of contour: {circularity:.2f}")
